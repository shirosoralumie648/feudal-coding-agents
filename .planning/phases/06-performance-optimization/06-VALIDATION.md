...
| 06-01-02 | 01 | 1 | PSC-01 | T-06-02 | Local metrics cache avoids repeated store reads inside TTL | unit | `COREPACK_HOME=/tmp/corepack CHOKIDAR_USEPOLLING=true corepack pnpm exec vitest run --config vitest.config.ts apps/control-plane/src/services/metrics-service.test.ts --pool=forks` | W0 covered | passed 2026-05-04 |
...
| 06-04-01 | 04 | 3 | PSC-01 | T-06-10 | Root typecheck is explicit, green, and pnpm-only | compiler | `COREPACK_HOME=/tmp/corepack corepack pnpm typecheck` | W0 covered | passed 2026-05-04 |
